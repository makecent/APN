...
data_root_train = 'my_data/ucf101/rawframes'
data_root_val = 'my_data/ucf101/rawframes'
ann_file_train = 'my_data/ucf101/annotations/apn_trainlist01.csv'
ann_file_val = 'my_data/ucf101/annotations/apn_testlist01.csv'
...
log_level = 'INFO'
work_dir = './work_dirs/apncls_r3dsony_24x1x1_10e_ucf101_rgb/'
load_from = None
resume_from = None
workflow = [('train', 1)]
