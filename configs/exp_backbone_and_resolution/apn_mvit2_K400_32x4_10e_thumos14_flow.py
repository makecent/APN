...
model = dict(
    type='APN',
    backbone=dict(type='MViT2', pretrained=False, flow_input=True),
    cls_head=dict(
        type='APNHead',
        num_classes=20,
        in_channels=768,
...
train_pipeline = [
    ...
    # dict(type='pytorchvideo.RandAugment', magnitude=7, num_layers=4, prob=0.5), not supported yet for optical flow
...
total_epochs = 10
fp16 = dict()
load_from = "work_dirs/apn_mvit2_32x4_10e_kinetics400_flow/epoch_10.pth"