...
ann_file_val = data_root + '/annotations/apn/demo_apn_test.csv'
...
# validation config
evaluation = dict(by_epoch=False, interval=42309, metrics=['top_k_accuracy', 'MAE', 'mAP'], save_best='mAP', rule='greater')
