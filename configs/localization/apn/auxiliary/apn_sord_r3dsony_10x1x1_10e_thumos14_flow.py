...
model = dict(
    ...
    cls_head=dict(
        ...
        in_channels=1024,
        output_type='stage_classification',
        loss=dict(type='ApnSORDLoss'),
        spatial_type='avg3d',
        clip_len=clip_len))
...
lr_config = dict(policy='CosineRestart',
                 ...
                 periods=[iter_per_epo, iter_per_epo, iter_per_epo, iter_per_epo*2, iter_per_epo*2, iter_per_epo*3],
                 min_lr=5e-06,
                 by_epoch=False)
total_epochs = 10

# evaluation
evaluation = dict(interval=1, save_best='mae', metrics=['mae'], output_type='classification', dataset_name='Val')
...
log_level = 'INFO'
work_dir = './work_dirs/apn_sord_r3dsony_lrsearch_10x1x1_10e_thumos14_flow/'
load_from = None
resume_from = None
workflow = [('train', 1)]
