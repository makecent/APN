num_classes = 20
temporal_range = 32
frame_interval = 1   # equal to x5 since fps is 5.
clip_len = int(temporal_range/frame_interval)

model = dict(
    type='APNonFeatures',
    num_classes=num_classes,
    in_channels=clip_len,
    feat_dim=200,
    output_type='coral',
...
feat_train = 'my_data/thumos14/thumos14_bsn_features/flow/'
feat_val = 'my_data/thumos14/thumos14_bsn_features/flow/'
...
log_level = 'INFO'
work_dir = './work_dirs/apn_coral_base_32x5_10e_th14bsn/'
load_from = None
resume_from = None
workflow = [('train', 1)]
