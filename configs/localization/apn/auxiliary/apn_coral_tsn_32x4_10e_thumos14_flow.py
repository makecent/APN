...
model = dict(
    type='APN',
    pretrained='checkpoints/tsn/tsn_r50_320p_1x1x8_110e_kinetics400_flow_20200705-1f39486b.pth',
    backbone=dict(
        type='ResNet',
        depth=50,
        norm_eval=False),
...
train_pipeline = [
    dict(type='FetchStackedFrames', clip_len=clip_len, frame_interval=frame_interval, num_clips=num_clips),
...
log_level = 'INFO'
work_dir = './work_dirs/apn_coral_tsn_32x4_10e_thumos14_flow/'
load_from = None
resume_from = None
workflow = [('train', 1)]
