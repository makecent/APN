...
lr_config = dict(policy='CosineRestart', restart_weights=[1, 1, 1, 1], periods=[1, 3, 3, 3], min_lr=5e-06, by_epoch=True)
total_epochs = 10
...
log_level = 'INFO'
work_dir = './work_dirs/apn_sord3_r3dsony_128x1x1_10e_thumos14_flow/'
load_from = None
resume_from = None
workflow = [('train', 1)]
