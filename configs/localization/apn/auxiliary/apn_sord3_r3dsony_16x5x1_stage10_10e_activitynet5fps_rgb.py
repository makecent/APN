...
train_pipeline = [
    dict(type='FetchStackedFrames', clip_len=clip_len),
...
log_level = 'INFO'
work_dir = './work_dirs/apn_sord3_r3dsony_16x5x1_stage10_10e_activitynet5fps_rgb/'
load_from = None
resume_from = None
workflow = [('train', 1)]
output_config = dict(out=f'{work_dir}/val_stride3_results.json')
