...
# evaluation
evaluation = dict(interval=1, save_best='mae',
                  metrics=['loss', 'mae', 'framecls_top_k_accuracy', 'framecls_mean_class_accuracy'],
                  results_component=('losses', 'argmax_progressions', 'exception_progressions', 'classification_scores'),
                  dataset_name='Val')
...
log_level = 'INFO'
work_dir = './work_dirs/apn_sord3_r3dsony_32x1x1_10e_thumos14_flow/'
load_from = None
resume_from = None
workflow = [('train', 1)]
