...
model = dict(
    ...
    cls_head=dict(
        ...
        loss=dict(type='ApnCELoss', uncorrelated_progs='ignore'),
        spatial_type='avg3d',
        clip_len=clip_len))
...
'losses', 'argmax_progressions', 'exception_progressions'), dataset_name='Val')
...
log_level = 'INFO'
work_dir = './work_dirs/apn_prop_ce_r3dsony_32x4_10e_thumos14_flow/'
load_from = None
resume_from = None
workflow = [('train', 1)]
