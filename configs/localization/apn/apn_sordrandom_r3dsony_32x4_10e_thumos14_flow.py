...
model = dict(backbone=dict(pretrained='checkpoints/r3d_sony/model_flow.pth', modality='flow'),
             cls_head=dict(loss=dict(type='ApnSORDLoss')))
optimizer = dict(lr=1e-5)
evaluation = dict(results_component=('losses', 'argmax_progressions', 'exception_progressions'))
...
# output settings
work_dir = './work_dirs/apn_sordrandom_r3dsony_32x4_10e_thumos14_flow/'
