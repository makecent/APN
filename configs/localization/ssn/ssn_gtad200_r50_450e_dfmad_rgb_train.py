...
data_root = 'my_data/dfmad70/rawframes/resized_train'
data_root_val = 'my_data/dfmad70/rawframes/resized_train'
data_root_test = 'my_data/dfmad70/rawframes/resized_test'
ann_file_train = 'my_data/dfmad70/proposals/dfmad_gtad_train_200_proposal.txt'
ann_file_val = 'my_data/dfmad70/proposals/dfmad_gtad_train_200_proposal.txt'
ann_file_test = 'my_data/dfmad70/proposals/dfmad_gtad_test_200_proposal.txt'
...
log_level = 'INFO'
work_dir = './work_dirs/ssn_gtad200_r50_450e_dfmad_rgb'
load_from = None
resume_from = None
workflow = [('train', 1)]
